...
sc = scrapingThread()
browser = webdriver.Chrome("../chromedriver.exe")
browser.get("https://www.staples.ca/en/Point-and-Shoot-Cameras/cat_CL200739_2-CA_1_20001")
html = browser.page_source
soup = BeautifulSoup(html)
sc.getInformation(soup)
browser.get("https://www.staples.ca/en/DSLR-Cameras/cat_CL204093_2-CA_1_20001")
html = browser.page_source
soup = BeautifulSoup(html)
sc.getInformation(soup)
conn.commit()
...
df["Image"] = images
df.to_csv("StaplesCameras.csv", index=False, encoding='utf-8')
