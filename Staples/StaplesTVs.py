...
class getPages:
    def getPage(self, pageNumber):
        try:
            ...
            url = "https://www.staples.ca/en/TVs/cat_CL200494_2-CA_1_20001"
            print url
...
class scrapingThread (threading.Thread):
    ...
    def run(self):
        ...
        browser.get("https://www.staples.ca/en/TVs/cat_CL200494_2-CA_1_20001")
        time.sleep(1)
...
df["Image"] = images
df.to_csv("StaplesTVs.csv", index=False, encoding='utf-8')
