...
class scrape ():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        try:
            ...
            url = "https://www.newegg.ca/Desktop-Computers/SubCategory/ID-10/Page-" + str(pageNumber) + "?Tid=6737&PageSize=96&order=BESTMATCH"
...
# df["Brand"] = brand
# df["Series"] = series
df.to_csv("newEggDesktops.csv",index=False, encoding='utf-8')