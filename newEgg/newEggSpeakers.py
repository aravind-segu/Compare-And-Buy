...
class scrape ():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        try:
            ...
            url = "https://www.newegg.ca/Home-Audio-Speakers/SubCategory/ID-494/Page-" + str(pageNumber) + "?cm_sp=Cat_Home-Audio_1-_-VisNav-_-Audio-Speakers&PageSize=96&order=BESTMATCH"
...
# df["Brand"] = brand
# df["Series"] = series
df.to_csv("newEggSpeakers.csv",index=False, encoding='utf-8')