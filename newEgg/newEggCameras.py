...
class scrape ():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        try:
            ...
            url = "https://www.newegg.ca/Product/ProductList.aspx?Submit=ENE&IsNodeId=1&bop=And&PMSub=12%20784%203008&PMSubCP=0&Page=" + str(pageNumber) + "&PageSize=96&order=BESTMATCH"
...
# df["Brand"] = brand
# df["Series"] = series
df.to_csv("newEggCameras.csv",index=False, encoding='utf-8')