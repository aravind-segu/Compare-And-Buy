...
class scrape ():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        try:
            ...
            url = "https://www.newegg.ca/LED-TV/SubCategory/ID-798/Page-" + str(pageNumber) + "?Tid=23190&order=BESTMATCH&PageSize=96"
...
t4 = threading.Thread(target=scrape.getInformation, args=(sc, 3, 4,))
t1.start()
t2.start()
t3.start()
t4.start()
...
# df["Brand"] = brand
# df["Series"] = series
df.to_csv("newEggTVs.csv",index=False, encoding='utf-8')