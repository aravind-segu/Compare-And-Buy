...
class scrape ():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        try:
            ...
            url = "https://www.newegg.ca/Cell-Phones-Unlocked/SubCategory/ID-2961/Page-" + str(pageNumber) + "?Tid=165973&PageSize=96&order=BESTMATCH"
...
# df["Brand"] = brand
# df["Series"] = series
df.to_csv("newEggPhones.csv",index=False, encoding='utf-8')