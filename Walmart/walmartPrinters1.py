...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        # if threadNum is 5:
        #     browser = browser5
        browser.get("https://www.walmart.ca/en/electronics/laptops-computers/printers-ink-scanners/ink-jet-printers/N-2013")
...
df["Images"] = images
oldSpeakers = pd.read_csv("walmartPrinters.csv")
...
master.to_csv("walmartPrinters.csv",index=False, encoding='utf-8')
