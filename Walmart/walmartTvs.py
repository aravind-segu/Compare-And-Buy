...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        if threadNum is 2:
            browser = browser2
        browser.get("https://www.walmart.ca/en/electronics/tv-home-theatre/televisions/N-1170/page-" + str(pageNumber))
        time.sleep(1)
        html = browser.page_source
        soup = BeautifulSoup(html)
...
df["Images"] = images
df.to_csv("walmartTVs.csv", index=False, encoding='utf-8')
