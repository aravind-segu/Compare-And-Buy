...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        if threadNum is 5:
            browser = browser5
        browser.get("https://www.walmart.ca/en/electronics/laptops-computers/laptops-notebooks/N-1855/page-" + str(pageNumber))
        time.sleep(1)
        html = browser.page_source
        soup = BeautifulSoup(html)
...
df["Images"] = images
df.to_csv("walmartLaptops.csv", index=False, encoding='utf-8')
