...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        if threadNum is 2:
            browser = browser2
        browser.get("https://www.walmart.ca/en/electronics/cell-phones-and-accessories/unlocked-phones/N-2226")
        time.sleep(1)
        html = browser.page_source
        soup = BeautifulSoup(html)
...
df["Images"] = images
df.to_csv("walmartsPhones.csv", index=False, encoding='utf-8')
