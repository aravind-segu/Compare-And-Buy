...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
        ...
        # if threadNum is 5:
        #     browser = browser5
        browser.get("https://www.walmart.ca/en/electronics/laptops-computers/printers-ink-scanners/all-in-one/N-2015")
...
df["Images"] = images
df.to_csv("walmartPrinters.csv", index=False, encoding='utf-8')
