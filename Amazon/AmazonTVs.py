...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
            try:
                ...
                tabletUrl = "https://www.amazon.ca/s/ref=sr_pg_2?rh=n%3A667823011%2Cn%3A%21677211011%2Cn%3A2690975011%2Cn%3A2690978011&page=" + str(pageNumber) + "&ie=UTF8&qid=1501917108"
                    ...
                    for element in ul.find_all("li", class_="s-result-item"):
                        ...
                        with scrape.add_lock:
                            ...
                            cursor.execute(
                                ...
                                (productName, price, link, modelNumber, productImage, vendor, mapping))
...
df["Model"] = model
print(df)
df.to_csv("AmazonTVs.csv",index=False, encoding='utf-8')
