...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
            try:
                ...
                tabletUrl = "https://www.amazon.ca/s/ref=lp_677250011_pg_2?rh=n%3A667823011%2Cn%3A%21677211011%2Cn%3A2404990011%2Cn%3A677250011&page="+ str(pageNumber)+"&ie=UTF8&qid=1501975372"
...
df["Model"] = model
print(df)
df.to_csv("AmazonDesktop.csv",index=False, encoding='utf-8')
