...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
            try:
                ...
                tabletUrl = "https://www.amazon.ca/s/ref=lp_3379583011_pg_2?rh=n%3A667823011%2Cn%3A%21677211011%2Cn%3A3379552011%2Cn%3A3379583011&page=" + str(pageNumber) +"&ie=UTF8&qid=1501954582&spIA=B01MR0E28X,B01NAP35PW,B00X6KVO0Q"
...
df["Model"] = model
print(df)
df.to_csv("AmazonPhones.csv",index=False, encoding='utf-8')
