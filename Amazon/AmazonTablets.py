...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
            try:
                ...
                tabletUrl = "https://www.amazon.ca/s/ref=lp_2690953011_pg_2?rh=n%3A667823011%2Cn%3A%21677211011%2Cn%3A2404990011%2Cn%3A2690953011&page=" + str(pageNumber) + "&ie=UTF8&qid=1500503284&spIA=B01LEVR0YM,B01MRXAWLO,B06Y3YC8LC"
                time.sleep(3)
