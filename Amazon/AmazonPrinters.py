...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
            try:
                ...
                tabletUrl = "https://www.amazon.ca/s/ref=lp_677265011_pg_2?rh=n%3A6205511011%2Cn%3A%216205512011%2Cn%3A677254011%2Cn%3A11259318011%2Cn%3A677265011&page="+str(pageNumber)+"&ie=UTF8&qid=1502122569&spIA=B01N3NCI5V,B015R1UOKW,B01BIGO5IW&lo=none"
...
df["Model"] = model
print(df)
df.to_csv("AmazonPrinters.csv",index=False, encoding='utf-8')
