...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
            try:
                ...
                tabletUrl = "https://www.amazon.ca/s/ref=sr_pg_5?rh=n%3A667823011%2Cn%3A%21677211011%2Cn%3A2404990011%2Cn%3A677252011&page=" + str(pageNumber) + "&ie=UTF8&qid=1501714059&spIA=B01FUZEKW8,B01FUW28DO,B06WRVCVNX,B01G2MQ63O,B01MZBPUK3,B01MZ9ATKU"
