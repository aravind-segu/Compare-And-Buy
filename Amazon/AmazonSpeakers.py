...
class scrape():
    ...
    def getInformation(self, pageNumber, threadNum):
            try:
                ...
                tabletUrl = "https://www.amazon.ca/s/ref=lp_677226011_pg_2?rh=n%3A667823011%2Cn%3A%21677211011%2Cn%3A677212011%2Cn%3A677226011&page=" + str(pageNumber) + "&ie=UTF8&qid=1502032216&spIA=B01HLVMGNE,B01L3XD9RS,B06XJ5H49C"
...
df["Model"] = model
print(df)
df.to_csv("AmazonSpeakers.csv",index=False, encoding='utf-8')
