...
speakers = pd.read_csv("./PrintersMaster.csv", names = ["modelNumber", "idNumber"])
laptopsFull = pd.DataFrame()
bestBuy = pd.read_csv("./BestBuy/BestBuySpeakers.csv")
...
amazon = pd.read_csv("./Amazon/AmazonSpeakers.csv")
...
newEgg = pd.read_csv("./newEgg/newEggSpeakers.csv")
print newEgg.columns.values
newEgg["name"] = "newEgg"
newEgg["ModelNumber"] = "none"
print newEgg.shape

snapDeal = pd.read_csv("./SnapDeal/snapdealSpeakers.csv")
print snapDeal.columns.values
snapDeal["name"] = "snapdeal"
print snapDeal.shape

source = pd.read_csv("./Source/SourceSpeakers.csv")
print source.columns.values
source["name"] = "source"
print source.shape

staples = pd.read_csv("./Staples/StaplesSpeakers.csv")
print staples.columns.values
staples.drop("IDValues", axis = 1, inplace = True)
staples.columns = ["ID", "Image", "ModelNumber", "Name", "Price", "Link"]
staples["name"] = "staples"
# print staples.head
# print staples.shape

walmart = pd.read_csv("./Walmart/walmartSpeakers.csv")
...
print speakers.head
speakers.to_csv("PrintersMaster.csv",index=False, encoding='utf-8')