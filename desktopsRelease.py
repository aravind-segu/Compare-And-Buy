...
speakers = pd.read_csv("./DesktopMaster.csv", names = ["modelNumber", "idNumber"])
laptopsFull = pd.DataFrame()
bestBuy = pd.read_csv("./BestBuy/BestBuyDesktops.csv")
...
amazon = pd.read_csv("./Amazon/AmazonDesktop.csv")
...
newEgg = pd.read_csv("./newEgg/newEggDesktops.csv")
print newEgg.columns.values
newEgg["name"] = "newEgg"
newEgg["ModelNumber"] = "none"
print newEgg.shape

snapDeal = pd.read_csv("./SnapDeal/snapdealDesktops.csv")
print snapDeal.columns.values
snapDeal["name"] = "snapdeal"
print snapDeal.shape

source = pd.read_csv("./Source/SourceDesktops.csv")
print source.columns.values
source["name"] = "source"
print source.shape

staples = pd.read_csv("./Staples/StaplesDesktops.csv")
...
walmart = pd.read_csv("./Walmart/walmartDesktops.csv")
...
print speakers.head
speakers.to_csv("DesktopMaster.csv",index=False, encoding='utf-8')