...
class getPages:
    ...
    def getPage(self, pageNumber):
            try:
                url = "https://www.flipkart.com/cameras/pr?otracker=categorytree&p%5B%5D=facets.type%255B%255D%3DFlash&p%5B%5D=facets.type%255B%255D%3DBody&p%5B%5D=facets.type%255B%255D%3DDSLR&p%5B%5D=facets.type%255B%255D%3DPoint%2B%2526%2BShoot&p%5B%5D=facets.type%255B%255D%3DInstant%2BCamera&page="+ str(pageNumber) + "&sid=jek%2Fp31&viewType=list"
                print url
                r = requests.get(url)
...
df.to_csv("FlipkartCameras.csv",index=False, encoding='utf-8')