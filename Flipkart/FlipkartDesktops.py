...
class getPages:
    ...
    def getPage(self, pageNumber):
            try:
                url = "https://www.flipkart.com/computers/desktop-pcs/all-in-one-pcs/pr?page=" + str(pageNumber) + "&sid=6bo%2Cnl4%2Cigk&viewType=grid&wid=1.productCard.PMU_V2"
                print url
                r = requests.get(url)
...
df.to_csv("FlipkartDesktops.csv",index=False, encoding='utf-8')