...
class getPages:
    ...
    def getPage(self, pageNumber):
            try:
                url = "https://www.flipkart.com/laptops/pr?otracker=CLP_lhs&p%5B%5D=sort%3Dpopularity&page=" + str(pageNumber) + "&sid=6bo%2Cb5g&viewType=list"
                print url
                r = requests.get(url)
...
df.to_csv("FlipkartLaptops.csv",index=False, encoding='utf-8')