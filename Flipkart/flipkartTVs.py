...
class getPages:
    ...
    def getPage(self, pageNumber):
            try:
                url = "https://www.flipkart.com/search?otracker=CLP_filters&otracker=clp_banner_1_4.bannerX3.BANNER_television-store_DDRPKS3XV1_wp4&page=" + str(pageNumber) + "&sid=ckf%2Fczl&viewType=list"
                print url
                r = requests.get(url)
...
df.to_csv("FlipkartTVs.csv",index=False, encoding='utf-8')