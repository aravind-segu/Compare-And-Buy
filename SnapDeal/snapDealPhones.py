...
browser.get("https://www.snapdeal.com/products/mobiles-mobile-phones/filters/Form_s~Smartphones?sort=plrty#bcrumbLabelId:175")
time.sleep(1)
...
df["Images"] = image
df.to_csv("snapdealPhones.csv",index=False, encoding='utf-8')
