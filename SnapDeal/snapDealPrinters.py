...
browser.get("https://www.snapdeal.com/search?keyword=printer&santizedKeyword=printer&catId=0&categoryId=46106299&suggested=false&vertical=p&noOfResults=20&clickSrc=searchOnSubCat&lastKeyword=&prodCatId=&changeBackToAll=false&foundInAll=false&categoryIdSearched=&cityPageUrl=&categoryUrl=&url=&utmContent=&dealDetail=&sort=rlvncy#bcrumbSearch:printer|bcrumbLabelId:46106299")
time.sleep(1)
...
df["Images"] = image
df.to_csv("snapdealPrinters.csv",index=False, encoding='utf-8')
