...
class getPages:
    ...
    def getPage(self, pageNumber):
            try:
                opener = urllib2.build_opener()
                opener.addheaders = [('User-agent', 'Mozilla/5.0')]
                url = "http://www.bestbuy.ca/en-ca/category/cell-phones-plans/696304.aspx?type=product&NVID=shop%3Bcell+phones%3Bcell+phones%3Blnk%3Bc1%3Br1%3Ben&page=" + str(pageNumber) + "&pageSize=64"
                print "entered"
                print url
...
df["Images"] = image
print modelNumber
df.to_csv("BestBuyPhones.csv",index=False, encoding='utf-8')
