...
class getPages:
    def getPage(self, pageNumber):
        try:
            opener = urllib2.build_opener()
            opener.add_handlers  = [('User-agent', 'Mozilla/5.0')]
            url = "https://www.thesource.ca/en-ca/tvs-and-home-theatre/audio-and-speakers/home-audio-speakers/c/scc-7-8-3?q=%3Arelevance&page="+ str(pageNumber) + "&view=grid"
            print url
...
df["Images"] = images
df.to_csv("SourceSpeakers.csv",index=False, encoding='utf-8')
