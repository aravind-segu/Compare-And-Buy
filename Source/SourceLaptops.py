...
class getPages:
    def getPage(self, pageNumber):
        try:
            opener = urllib2.build_opener()
            opener.add_handlers  = [('User-agent', 'Mozilla/5.0')]
            url = "https://www.thesource.ca/en-ca/computers-and-tablets/laptops/all-laptops/c/scc-1-2-1?q=%3Arelevance&page=" + str(pageNumber) + "&view=grid"
            print url
...
df.to_csv("SourceLaptops.csv",index=False, encoding='utf-8')
